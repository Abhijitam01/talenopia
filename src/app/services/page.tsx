    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f2f1ef] py-20 px-[4%]">
        <div className="grid lg:grid-cols-2 gap-20 items-start">
           <motion.div
             ...
             variants={fadeInUp}
           >
              <span className="inline-block text-[0.58rem] font-bold tracking-[0.2em] uppercase bg-[#c8102e] text-white px-3 py-1 mb-4">
                01 — IT Augmentation
              </span>
           ...
           > 
              <div className="text-[0.63rem] font-bold tracking-[0.2em] uppercase text-[#c8102e] mb-4">Why IT Augmentation?</div>
      ...
      <section className="bg-white py-20 px-[4%]">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
           {/* Visual Side (Left on Desktop but reversed in layout) */}
           <motion.div
             initial={{ opacity: 0, x: -20 }}
             whileInView={{ opacity: 1, x: 0 }}
             viewport={{ once: true }}
           ...
           >
              ...
              <div className="text-[0.63rem] font-bold tracking-[0.2em] uppercase text-[#c8102e] mb-3">Dual Capability</div>
      ...
      <section className="bg-[#f2f1ef] py-20 px-[4%]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2.5">
            ...
            <motion.div
              ...
              className="md:col-span-1 p-7 bg-[#c8102e] text-white hover:shadow-lg transition-all"
            >
               <div className="text-3xl mb-4">⛓️</div>
       ...
       <section className="bg-[#0a0a0a] py-24 px-[4%]">
          ...
          >
             ...
             <h2 className="font-serif text-[2.6rem] text-white mb-5">
               Flexible Structures. <em className="italic text-[#c8102e]">Complete Transparency.</em>
             </h2>
             <div className="w-10 h-[3px] bg-[#c8102e] mb-8" />
             <p className="text-[0.93rem] leading-[1.78] text-white/55 max-w-lg mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-[1px] bg-white/[0.08] border border-white/[0.08]">
             {[
               ...
               { icon: "▣", title: "Fixed Resources", text: "Stable, committed resources aligned to defined responsibilities and long-term organizational requirements." },
                ...
                <div key={i} className="bg-[#0a0a0a] p-8 hover:bg-[#c8102e]/10 transition-colors group">
                   <h3 className="text-[0.82rem] font-bold text-white mb-2 flex items-center gap-2">
                      <span className="text-[#c8102e] text-xs">{item.icon}</span> {item.title}
                   </h3>
                   <p className="text-[0.76rem] text-white/40 leading-[1.65] group-hover:text-white/60 transition-colors">
                      {item.text}
                   </p>
                </div>
             ))}
             <div className="bg-[#c8102e]/10 p-8 border-l border-[#c8102e]/20">
                <h3 className="text-[0.82rem] font-bold text-white mb-2 flex items-center gap-2">
                   <span className="text-[#c8102e] text-xs">↻</span> Replacement Support
                </h3>
                <p className="text-[0.76rem] text-white/40 leading-[1.65]">
       ...
       <div className="bg-white py-20 px-[4%]">
        <div className="bg-[#c8102e] py-16 px-10 flex flex-wrap items-center justify-between gap-10 rounded-sm">
