    ...
    <div className="bg-white">
      ...
      <section className="bg-[#0a0a0a] text-white pt-28 pb-20 px-[4%] text-center relative overflow-hidden">
        ...
        >
           ...
           >
             ...
             with <span className="text-[#c8102e]">Purpose</span>
           </motion.h1>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
           ...
           >
              ...
              <h2 className="font-serif text-[2.6rem] text-[#0a0a0a] mb-5">
                Long-Term <em className="italic text-[#c8102e]">Professional</em> Relationships
              </h2>
              <div className="w-10 h-[3px] bg-[#c8102e] mb-10" />
              ...
              <div className="grid grid-cols-2 gap-2">
                 {[
                   ...
                   "Data Engineering"
                    ...
                    >
                      <span className="text-[#c8102e] text-[0.62rem] group-hover:text-white transition-colors">▸</span>
                      {role}
                    </div>
                 ))}
              </div>
      ...
      <section className="bg-[#f2f1ef] py-24 px-[4%]">
         <div className="max-w-3xl mx-auto">
            ...
            >
               <div className="text-[0.63rem] font-bold tracking-[0.22em] uppercase text-[#c8102e] mb-3">How to Apply</div>
               ...
               {[
                 ...
                 { num: "4", title: "We'll Reach Out", text: "Our team reviews your details and reaches out if there's a suitable match for your profile." }
                  ...
                  <motion.div
                    ...
                    className="flex items-start gap-5 p-6 bg-white border border-[#dedbd6] hover:border-[#c8102e] transition-colors"
                  >
                     <div className="font-display text-[1.4rem] text-[#c8102e] leading-none shrink-0 w-8 pt-1">
                       {step.num}
                     </div>
                     <div>
            ...
            <div className="text-center mt-12">
               <Link
                 href="mailto:careers@talenopia.com"
                 className="bg-[#0a0a0a] text-white px-10 py-4 text-[0.75rem] font-bold tracking-[0.12em] uppercase hover:bg-[#c8102e] transition-all inline-flex items-center gap-2"
               >
      ...
      {/* ───── CTA ───── */}
      <div className="bg-[#0a0a0a] py-20 px-[4%] text-center border-t border-white/[0.1]">
         <motion.h2
         ...
         >
           <Link
             href="mailto:careers@talenopia.com"
             className="border border-white text-white px-8 py-3.5 text-[0.75rem] font-bold tracking-[0.12em] uppercase hover:bg-white/10 transition-all inline-flex items-center gap-2"
           >
             Email Your Profile
           </Link>
         </motion.div>
